...
def update_tool():
	...
	banner()
	source = r.get("https://raw.githubusercontent.com/khiyarmotory/telegram/master/.version")
	if source.text == '3':
		...
		os.system("""
			curl -s -O https://raw.githubusercontent.com/khiyarmotory/telegram/master/add2group.py
			curl -s -O https://raw.githubusercontent.com/khiyarmotory/telegram/master/scraper.py
			curl -s -O https://raw.githubusercontent.com/khiyarmotory/telegram/master/setup.py
			curl -s -O https://raw.githubusercontent.com/khiyarmotory/telegram/master/smsbot.py
			chmod 777 *.py
			""");time.sleep(3)
